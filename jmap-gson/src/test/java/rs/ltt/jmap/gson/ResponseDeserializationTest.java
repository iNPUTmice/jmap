    ...
    public void deserializeInvalidResponse() {
        final JsonParseException exception =
                Assertions.assertThrows(
                        ...
                        () ->
                                parseFromResource(
                                        "response/invalid-response.json", GenericResponse.class));
    ...
    public void deserializeResponseInvalidInvocationArray() {
        final JsonParseException exception =
                Assertions.assertThrows(
                        ...
                        () ->
                                parseFromResource(
                                        "response/invalid-invocation-array.json",
                                        GenericResponse.class));
        Assertions.assertEquals(
                "Invocation array has 2 values. Expected 3", exception.getMessage());
    }
    ...
    public void deserializeResponseInvalidInvocationNoName() {
        final JsonParseException exception =
                Assertions.assertThrows(
                        ...
                        () ->
                                parseFromResource(
                                        "response/invalid-invocation-no-name.json",
                                        GenericResponse.class));
        Assertions.assertEquals(
                "Name (index 0 of JsonArray) must be a primitive string", exception.getMessage());
    }

    @Test
    public void deserializeResponseInvalidInvocationUnknownMethod() {
        final ResponseInvocationDeserializer.UnknownMethodNameException exception =
                Assertions.assertThrows(
                        ResponseInvocationDeserializer.UnknownMethodNameException.class,
                        () ->
                                parseFromResource(
                                        "response/invalid-invocation-unknown.json",
                                        GenericResponse.class));
